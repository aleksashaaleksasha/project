...
class GameMainWindow(QMainWindow):
    ...
    def end_turn(self):
        ...
        if sum(chosen_cards) == 0:
            ...
            QtCore.QTimer.singleShot(self.enemy_turn_delay(self.enemy[2])+500, lambda: self.new_turn())
    ...
    def enemy_turn(self, enemy_name):
        ...
        if r == 1:
            ...
            QtCore.QTimer.singleShot(1000 + enemy_name.enemy.number * 300 + enemy_name.attack_movie.frameCount() * 150,
            ...
            QtCore.QTimer.singleShot(500 + enemy_name.enemy.number * 150 + enemy_name.attack_movie.frameCount() * 75, lambda: self.play_animation(self.hero_hurt_movie))
            QtCore.QTimer.singleShot(500 + enemy_name.enemy.number * 150 + enemy_name.attack_movie.frameCount() * 75 + self.hero_hurt_movie.frameCount()*150, lambda: self.idle_hero())
